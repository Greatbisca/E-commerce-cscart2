<?php /* Smarty version Smarty-3.1.21, created on 2021-06-08 20:42:12
         compiled from "C:\xampp\htdocs\cscart2\design\backend\templates\views\addons\components\detailed_page\tabs\addon_update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:171194720760bfabf4452887-76625070%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3740cdaef22b4ec68dcaf2402867b68e35cb0a33' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart2\\design\\backend\\templates\\views\\addons\\components\\detailed_page\\tabs\\addon_update.tpl',
      1 => 1622708843,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '171194720760bfabf4452887-76625070',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60bfabf44a32c9_41964441',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60bfabf44a32c9_41964441')) {function content_60bfabf44a32c9_41964441($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\modifier.date_format.php';
?><?php
...
$_tmp6=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"text",'class'=>"btn",'text'=>$_smarty_tpl->__("addons.upgrade_to_version",array("[version]"=>$_smarty_tpl->tpl_vars['actual_change_log']->value['version'])),'href'=>$_tmp6));?>
                        ...
                        <div class="controls">
                            <div class="spaced-child">
                                ...
                                <?php } elseif ($_smarty_tpl->tpl_vars['version_compare']->value<0) {?>
                                    ...
                                    <?php ob_start();
echo htmlspecialchars(fn_url("upgrade_center.manage"), ENT_QUOTES, 'UTF-8');
$_tmp7=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"text",'class'=>"btn",'text'=>$_smarty_tpl->__("addons.upgrade_to_product_version",array("[product]"=>(defined('PRODUCT_NAME') ? constant('PRODUCT_NAME') : null),"[version]"=>$_smarty_tpl->tpl_vars['actual_change_log']->value['compatibility'])),'href'=>$_tmp7));?>
                        ...
                        <div class="controls">
                            <div class="spaced-child">
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['addon']->value['marketplace']['upgrade_available']) {?>
                                    <?php ob_start();
echo htmlspecialchars(fn_url("upgrade_center.manage"), ENT_QUOTES, 'UTF-8');
$_tmp8=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"text",'class'=>"btn",'text'=>$_smarty_tpl->__("addons.upgrade_to_version",array("[version]"=>$_smarty_tpl->tpl_vars['latest_change_log']->value['version'])),'href'=>$_tmp8));?>
