<?php /* Smarty version Smarty-3.1.21, created on 2021-06-08 20:40:33
         compiled from "C:\xampp\htdocs\cscart2\design\backend\templates\common\fileuploader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:186433739060bfab918133e6-13876217%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '666a151a6c51b793015350cc44950a06bab17d38' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart2\\design\\backend\\templates\\common\\fileuploader.tpl',
      1 => 1622708843,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '186433739060bfab918133e6-13876217',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60bfab91860982_11021119',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60bfab91860982_11021119')) {function content_60bfab91860982_11021119($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\block.inline_script.php';
...
$_tmp31=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["id_var_name"] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['prefix']->value).$_tmp31, null, 0);?>
...
"><?php }?>
                <?php if (!($_smarty_tpl->tpl_vars['po']->value['required']==smarty_modifier_enum("YesNo::YES")&&smarty_modifier_count($_smarty_tpl->tpl_vars['images']->value)==1)) {?><i id="clean_selection_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_var_name']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image']->value['file'], ENT_QUOTES, 'UTF-8');?>
...
');" class="icon-remove-sign cm-tooltip hand"></i>&nbsp;<?php }?>
                <?php if ($_smarty_tpl->tpl_vars['delete_link']->value) {?></a><?php }?>
                <span><?php if ($_smarty_tpl->tpl_vars['download_link']->value) {?><a href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['download_link']->value), ENT_QUOTES, 'UTF-8');?>
"><?php }
...
" class="cm-fileuploader-field <?php if ($_smarty_tpl->tpl_vars['is_image']->value) {?>cm-image-field<?php }?>" <?php if ($_smarty_tpl->tpl_vars['disabled_param']->value) {?>disabled<?php }?>/><input type="hidden" name="type_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['var_name']->value, ENT_QUOTES, 'UTF-8');?>
...
" class="cm-fileuploader-field <?php if ($_smarty_tpl->tpl_vars['is_image']->value) {?>cm-image-field<?php }?>" <?php if ($_smarty_tpl->tpl_vars['disabled_param']->value) {?>disabled<?php }?>/><div class="btn-group <?php if ($_smarty_tpl->tpl_vars['multiupload']->value!="Y"&&$_smarty_tpl->tpl_vars['images']->value) {?>hidden<?php }?>" id="link_container_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_var_name']->value, ENT_QUOTES, 'UTF-8');?>
