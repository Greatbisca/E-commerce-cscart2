<?php /* Smarty version Smarty-3.1.21, created on 2021-06-08 20:40:44
         compiled from "C:\xampp\htdocs\cscart2\design\backend\templates\views\index\components\dashboard.tpl" */ ?>
<?php /*%%SmartyHeaderCode:178141680360bfab9c636af1-23004846%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '923c0e4b4e02829e62fdba0f6ab519c3b25644b5' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart2\\design\\backend\\templates\\views\\index\\components\\dashboard.tpl',
      1 => 1622708843,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '178141680360bfab9c636af1-23004846',
  'function' => 
  array (
    'show_log_row' => 
    array (
  ...
  'unifunc' => 'content_60bfab9c7404c8_20387801',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60bfab9c7404c8_20387801')) {function content_60bfab9c7404c8_20387801($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\block.inline_script.php';
if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_modifier_count')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\modifier.count.php';
...
<?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"index:index")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"index:index"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
    ...
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"index:alert_block")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"index:alert_block"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
        ...
        <?php }?>
    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"index:alert_block"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
%
            ...
            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"index:products_statistic")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"index:products_statistic"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
$_tmp1=ob_get_clean();?><?php echo htmlspecialchars(fn_url("products.manage?amount_from=&amount_to=0&tracking[0]=".$_tmp1), ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars(number_format($_smarty_tpl->tpl_vars['general_stats']->value['products']['out_of_stock_products']), ENT_QUOTES, 'UTF-8');?>
                ...
                <?php }?>
            <?php }?>
            <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"index:products_statistic"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
">
                            ...
                            <div class="span6">
                                <table class="table">
                                    <tbody>
                                        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"index:vendors_activity")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"index:vendors_activity"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">
                                        ...
                                        <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"index:vendors_activity"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
" data-toggle="tab"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status']->value['description'], ENT_QUOTES, 'UTF-8');?>
 ...
 $_from = $_smarty_tpl->tpl_vars['orders']->value['all']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
if ($_smarty_tpl->tpl_vars['order']->value['user_id']) {?></a><?php }?></td>
                                                ...
                                                <td data-th="&nbsp;"><h4><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['order']->value['total']), 0);?>
</h4></td>
                                            </tr>
                                            <?php }
if (!$_smarty_tpl->tpl_vars['order']->_loop) {
?>
                                            <tr><td data-th="&nbsp;"><?php echo $_smarty_tpl->__("no_data");?>
</td></tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
...
">
                                    <div class="table-responsive-wrapper">
                                        <table class="table table-middle table--relative table-last-td-align-right table-responsive table-responsive-w-titles">
                                            <tbody>
                                            <?php  $_smarty_tpl->tpl_vars['order'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['order']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['orders']->value[$_smarty_tpl->tpl_vars['status']->value['status']]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['order']->key => $_smarty_tpl->tpl_vars['order']->value) {
$_smarty_tpl->tpl_vars['order']->_loop = true;
?>
                                                <tr>
...
?>
                                            <?php $_smarty_tpl->tpl_vars['url'] = new Smarty_variable(fn_url("orders.manage?is_search=Y&storefront_id=".((string)$_smarty_tpl->tpl_vars['storefront_id']->value)."&period=C&time_from=".((string)$_smarty_tpl->tpl_vars['time_from']->value)."&time_to=".((string)$_smarty_tpl->tpl_vars['time_to']->value)."&status[]=".((string)$_smarty_tpl->tpl_vars['order_status']->value['status'])), null, 0);?>
                                            <tr>
...
"><?php echo $_smarty_tpl->__('show_all');?>
                        ...
                        <?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\block.hook.php';
if (!is_callable('smarty_modifier_date_format')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\modifier.date_format.php';
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/daterange_picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"dashboard_date_picker",'extra_class'=>"pull-right",'data_url'=>fn_url("index.index?storefront_id=".((string)$_smarty_tpl->tpl_vars['storefront_id']->value)),'result_ids'=>"dashboard",'start_date'=>$_smarty_tpl->tpl_vars['time_from']->value,'end_date'=>$_smarty_tpl->tpl_vars['time_to']->value), 0);?>
