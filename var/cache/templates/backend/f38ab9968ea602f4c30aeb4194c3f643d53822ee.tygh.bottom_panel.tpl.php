<?php /* Smarty version Smarty-3.1.21, created on 2021-06-10 20:48:02
         compiled from "C:\xampp\htdocs\cscart2\design\backend\templates\components\bottom_panel\bottom_panel.tpl" */ ?>
<?php /*%%SmartyHeaderCode:28980024560c250523c5c94-56640306%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f38ab9968ea602f4c30aeb4194c3f643d53822ee' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart2\\design\\backend\\templates\\components\\bottom_panel\\bottom_panel.tpl',
      1 => 1622708843,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '28980024560c250523c5c94-56640306',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60c25052471495_44811865',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60c25052471495_44811865')) {function content_60c25052471495_44811865($_smarty_tpl) {?><?php if (!is_callable('smarty_block_styles')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\block.styles.php';
...
if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\cscart2\\app\\lib\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.replace.php';
...
echo htmlspecialchars(fn_url('',"A"), ENT_QUOTES, 'UTF-8');
        ...
        <div class="bp-nav">
            ...
            <a href="<?php echo htmlspecialchars(fn_url("bottom_panel.redirect?url=".((string)urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']))."&area=".((string)(defined('AREA') ? constant('AREA') : null))."&to_area=C",$_smarty_tpl->tpl_vars['redirect_area']->value), ENT_QUOTES, 'UTF-8');?>
"
...
$_tmp5=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.disable_mode?type=live_editor&return_url=".$_tmp5), ENT_QUOTES, 'UTF-8');?>
"
                    <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value==="theme") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_tmp6=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.disable_mode?type=theme_editor&return_url=".$_tmp6), ENT_QUOTES, 'UTF-8');?>
"
                    <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value==="build") {?>
                        href="<?php ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_tmp7=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.disable_mode?type=block_manager&return_url=".$_tmp7), ENT_QUOTES, 'UTF-8');?>
"
                    <?php } else { ?>
...
$_tmp8=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.update_mode?type=live_editor&status=enable&return_url=".$_tmp8), ENT_QUOTES, 'UTF-8');?>
"
...
ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['c_url']->value), ENT_QUOTES, 'UTF-8');
$_tmp9=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.update_mode?type=theme_editor&status=enable&return_url=".$_tmp9), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
...
ob_start();
echo htmlspecialchars(urlencode($_smarty_tpl->tpl_vars['c_url']->value), ENT_QUOTES, 'UTF-8');
$_tmp10=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.update_mode?type=block_manager&status=enable&return_url=".$_tmp10), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
