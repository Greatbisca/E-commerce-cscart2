<?php /* Smarty version Smarty-3.1.21, created on 2021-06-08 20:42:19
         compiled from "C:\xampp\htdocs\cscart2\design\backend\templates\views\companies\update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:113910634660bfabfb601944-05203487%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '178666784cfb6e86ae8982c6e29778ec67a4b154' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart2\\design\\backend\\templates\\views\\companies\\update.tpl',
      1 => 1622708843,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '113910634660bfabfb601944-05203487',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60bfabfb709c40_72522199',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60bfabfb709c40_72522199')) {function content_60bfabfb709c40_72522199($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\modifier.enum.php';
if (!is_callable('smarty_function_split')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\function.split.php';
if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_modifier_puny_decode')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\modifier.puny_decode.php';
...
if (!is_callable('smarty_block_component')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\block.component.php';
if (!is_callable('smarty_modifier_in_array')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\modifier.in_array.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('use_existing_store','storefront','none','recommended','information','name','storefront_url','ttc_storefront_url','design','localization','status','active','pending','new','disabled','language','create_administrator_account','settings','company','description','redirect_customer_from_storefront','entry_page','none','index','all_pages','countries','shipping_methods','available_for_vendor','shipping_methods','disabled','available_for_vendor','no_data','menu','view_vendor_products','view_vendor_categories','view_vendor_admins','view_vendor_users','view_vendor_orders','vendors_statistics','balance','orders','sales','income','active_products','out_of_stock_products','save','delete','new_vendor','add_storefront'));
?>
