<?php /* Smarty version Smarty-3.1.21, created on 2021-06-08 20:40:34
         compiled from "C:\xampp\htdocs\cscart2\design\backend\templates\common\mainbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:107978170060bfab922c7186-09834197%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '197fc2c985fa37dac708454e5c9d3f0b77867f92' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart2\\design\\backend\\templates\\common\\mainbox.tpl',
      1 => 1622708843,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '107978170060bfab922c7186-09834197',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60bfab9234cac5_05440980',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60bfab9234cac5_05440980')) {function content_60bfab9234cac5_05440980($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\block.inline_script.php';
if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_block_notes')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\block.notes.php';
if (!is_callable('smarty_modifier_sanitize_html')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\modifier.sanitize_html.php';
if (!is_callable('smarty_modifier_sizeof')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\modifier.sizeof.php';
if (!is_callable('smarty_function_script')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\function.script.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('notes','search','all_vendors','choose_action','language'));
?>
...
<?php $_tmp32=ob_get_clean();?><?php if (fn_check_view_permissions($_smarty_tpl->tpl_vars['m']->value['href'],$_tmp32)) {?>
...
"
    ...
    <div class="title pull-left <?php if ($_smarty_tpl->tpl_vars['select_storefront']->value) {?>title--storefronts<?php }?>">
...
" form="global_search" placeholder="<?php echo $_smarty_tpl->__("search");?>
" disabled /></label>
            </div>
        </div>
