<?php /* Smarty version Smarty-3.1.21, created on 2021-06-10 20:48:03
         compiled from "C:\xampp\htdocs\cscart2\design\backend\templates\menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:156040761360c25053206095-42663783%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '413d3b1f6f27a1eec2873bfd1d67ad50eff8aaa1' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart2\\design\\backend\\templates\\menu.tpl',
      1 => 1622708843,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '156040761360c25053206095-42663783',
  'function' => 
  array (
    'menu_attrs' => 
    array (
  ...
  'unifunc' => 'content_60c250533094e3_90554197',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60c250533094e3_90554197')) {function content_60c250533094e3_90554197($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\block.hook.php';
            ...
            <ul class="nav">
                <li class="nav-company">
                    <?php if ($_smarty_tpl->tpl_vars['auth']->value['user_type']==smarty_modifier_enum("UserTypes::ADMIN")) {?>
                        <?php $_smarty_tpl->tpl_vars['storefront_url'] = new Smarty_variable(fn_url("profiles.act_as_user?user_id=".((string)$_smarty_tpl->tpl_vars['auth']->value['user_id'])."&area=C"), null, 0);?>
                    <?php } else { ?>
                        <?php $_smarty_tpl->tpl_vars['storefront_url'] = new Smarty_variable($_smarty_tpl->tpl_vars['runtime']->value['company_id'] ? "companies.products?company_id=".((string)$_smarty_tpl->tpl_vars['runtime']->value['company_id']) : '', null, 0);?>
