<?php /* Smarty version Smarty-3.1.21, created on 2021-06-08 20:40:32
         compiled from "C:\xampp\htdocs\cscart2\design\backend\templates\views\addons\components\manage\addons_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6321182460bfab90a46659-12460313%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f32345cc1cab10d1b8cfce353fb23b69b6aaa02a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart2\\design\\backend\\templates\\views\\addons\\components\\manage\\addons_search_form.tpl',
      1 => 1622708843,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '6321182460bfab90a46659-12460313',
  'function' => 
  array (
  ),
  'variables' => 
 ...
 (<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['developer']->value['position'], ENT_QUOTES, 'UTF-8');?>
        ...
        <div class="sidebar-field">
            <div class="control-group">
                ...
                <label class="control-label checkbox" for="unidentified">
                    <input type="checkbox" id="unidentified" name="unidentified" value="<?php echo htmlspecialchars(smarty_modifier_enum("YesNo::YES"), ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->tpl_vars['search']->value['unidentified']) {?> checked="checked"<?php }?>>
                    <span>
                        <?php echo $_smarty_tpl->__("unidentified");?>
