<?php /* Smarty version Smarty-3.1.21, created on 2021-06-14 22:32:16
         compiled from "C:\xampp\htdocs\cscart2\design\themes\responsive\templates\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:159137684360c7aec0864fc5-21844781%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '16c401b54bdce6283fe676d4cda320bc4a255f84' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart2\\design\\themes\\responsive\\templates\\index.tpl',
      1 => 1623172719,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '159137684360c7aec0864fc5-21844781',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60c7aec0904344_51243175',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60c7aec0904344_51243175')) {function content_60c7aec0904344_51243175($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_modifier_count')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\modifier.count.php';
if (!is_callable('smarty_function_render_location')) include 'C:/xampp/htdocs/cscart2/app/functions/smarty_plugins\\function.render_location.php';
?><?php
...
$_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/toolbar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('title'=>$_smarty_tpl->__("on_site_template_editing"),'href'=>"customization.disable_mode?type=design&return_url=".$_tmp1), 0);?>
        ...
        <?php } elseif ($_smarty_tpl->tpl_vars['is_bottom_panel_available']->value) {?>
            <?php echo $_smarty_tpl->getSubTemplate ("backend:components/bottom_panel/bottom_panel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('logo'=>(($tmp = @$_smarty_tpl->tpl_vars['logo']->value['theme']['image'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['logos']->value['theme']['image'] : $tmp)), 0);?>

        <?php }?>

        <div class="ty-tygh <?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['theme_editor']) {?>te-mode<?php }?> <?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['live_editor']||$_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']||$_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['block_manager']||(defined('THEMES_PANEL') ? constant('THEMES_PANEL') : null)) {?>ty-top-panel-padding<?php }?> bp-tygh-container" id="tygh_container">
        ...
        <div class="ty-helper-container <?php if ($_COOKIE['pb_is_bottom_panel_open']==="true") {?>bp-tygh-main-container--padding<?php }?>" id="tygh_main_container">
